    ...
    >
      ...
      <div className="flex items-start gap-4">
        ...
        <div>
          ...
          >
            Operational financial and member reports
          </p>
        </div>
      </div>
      ...
      <motion.button
        ...
        whileTap={{ scale: 0.98 }}
        className={`flex items-center justify-center gap-2 px-5 py-3 rounded-xl font-medium transition-all border shadow-sm
        ${
          theme === "dark"
