  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-5">
        ...
        <div className={`h-12 w-40 ${shimmer}`} />
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-4 gap-6">
        ...
        {[1, 2, 3, 4].map((item) => (
          ...
          >
            ...
            <div className={`mt-6 h-4 w-32 ${shimmer}`} />
      ...
      <div className="grid grid-cols-1 xl:grid-cols-3 gap-6">
        ...
        <div className={`${cardClass} xl:col-span-2 p-6`}>
          ...
          <div
            className={`mt-8 h-72 rounded-xl
            ${
              theme === "dark"
                ? "bg-gray-700/40"
                : "bg-gray-100"
      ...
      <div className={cardClass}>
        ...
        <div className="overflow-hidden">
          ...
          {[1, 2, 3, 4, 5].map((row) => (
            <div
              key={row}
              className="grid grid-cols-4 gap-4 p-6 border-b border-gray-700/10"
            >
