              ...
              {formData.instructions.map((instruction, index) => (
                ...
                >
                    <input
                      ...
                      className="flex-1 rounded-xl border border-gray-300 bg-white px-4 py-3 outline-none focus:border-orange-500 dark:border-slate-700 dark:bg-slate-900 dark:text-white"
                    />
